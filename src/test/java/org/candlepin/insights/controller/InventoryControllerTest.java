...
import org.candlepin.insights.rhsm.client.RhsmApiProperties;
...
import org.candlepin.insights.rhsm.client.model.OrgInventory;
...
public class InventoryControllerTest {
    ...
    void testHandlesEmptyList()
        ...
        when(rhsmService.getPageOfConsumers(eq("org123"), nullable(String.class), anyString())
            ...
            new OrgInventory().body(Collections.emptyList()).pagination(pagination)
        );
